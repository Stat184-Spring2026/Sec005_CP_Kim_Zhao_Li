...
## The Relationship Between The Number Of Players And The Prize Money Of The Tournament(JiXianLi)
```{r}
#| label: fig-PlayersAndPrice
#| fig-cap: "The Relationship Between The Number Of Players And The Prize Money Of The Tournament"
#| fig-pos: H
#| fig-width: 9
#| fig-height: 4.5
...
ggplot(dataTable, aes(x = `Total Active Players`, y = `Total Prize Money`)) +
  ...
  labs(
    title = "The Relationship Between Total Active Players and Total Prize Money Of The Tournament",
